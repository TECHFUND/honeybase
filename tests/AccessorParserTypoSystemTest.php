...
class AccessorParserTypoSystemTest extends TestCase {

  // DI
  public function testSetAccessor(){
    // ready
    $accessor = Util::getJSON(__DIR__."/accessor_typo.json");
    ...
    $this->assertFalse( property_exists($parser->accessor, "database") );
    $this->assertFalse( property_exists($parser->accessor, "register") );
  } // str->bool
  ...
  */
  ...
  public function testClimbTableBranch(){
    ...
    // assert
    $this->assertFalse($result); // "databse" typo exist, so return false
