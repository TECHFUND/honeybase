(function(global){
  var config = getConfig("origins.json");

  console.log(config);
  var env = "development";
  switch(location.protocol + "//" +location.host){
    case config.development.origin:
      env = "development";
      break;
    case config.sttaging.origin:
      env = "staging";
      break;
    case config.production.origin:
      env = "production";
      break;
    default:
